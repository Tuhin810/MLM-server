import { AutoPoolRepository } from "../repositories/AutoPoolRepository.js";
import { WalletRepository } from "../repositories/WalletRepository.js";
import { UserRepository } from "../repositories/UserRepository.js";
import { prisma } from "../config/db.js";
import { TransactionType, IncomeType, AutoPoolMember } from "@prisma/client";
...
const PER_CHILD_REWARDS: Record<number, number> = {
  1: 4,       // 8 / 2
  2: 5,       // 20 / 4
  3: 40,      // 320 / 8
  4: 300,     // 4800 / 16
...
export class AutoPoolService {
  async joinAutoPool(userId: string) {
  ...
  async getIncomeLogs(userId: string) {
